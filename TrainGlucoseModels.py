...
file_name=patient_name+"_Dexcom_Insulet_patientData.json"
...
print("Ages",ages)
# exit()
ml.train([data,ages],y,epochs=epochs)
ml.model.save_weights("GlucosePatientModels/Patient_"+file_name.replace(".json","")+"weights20-20-age-3layers-256-time.h5")
# ml.create_look_back()